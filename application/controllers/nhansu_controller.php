...
//file UploadHandler.php có trong thư mục controllers(cùng cấp với nhansu_controller.php)
//vì cùng là file php nên ta có thể để cùng cao61 với nhansu_controller
...
class nhansu_controller extends CI_Controller {
	...
	public function ajax_add()
	{
		...
		$sodonhang=$this->input->post('sodonhang');
		//$anhavatar= base_url()."Fileupload/".basename( $_FILES["anhavatar"]["name"]);
		//$anhavatar="https://i-vnexpress.vnecdn.net/2017/08/25/Anh-1503645731-6333-1503645884_180x108.jpg";
		...
		if($this->nhansu_model->insertDataToMySQL($ten,$tuoi,$anhavatar,$linkfb,$sodonhang,$sdt))
		{
			...
			echo "Bạn nên upload lại, xem lại code";
		}

	}
	public function uploadfile()
	{
		// Định nghĩa 1 đối tượng UploadHandler
